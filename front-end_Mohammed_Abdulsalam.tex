...
\small{
  I am a highly skilled software engineer with over \textbf{4 year of experience} in \textbf{HTML, CSS, Javascript}. I have knowledge of popular frameworks such as \textbf{React, and Vue.js} and experience with REST APIs.
}
%--------------------------------------------
