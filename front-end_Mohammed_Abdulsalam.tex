...
\small{
  I am a highly skilled software engineer with over \textbf{4 years of experience} in \textbf{HTML, CSS, and Javascript}. I know popular frameworks such as \textbf{React} and experience with REST APIs.
}
%--------------------------------------------
