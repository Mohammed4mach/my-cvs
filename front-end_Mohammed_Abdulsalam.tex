...
\small{
  I am a highly skilled web developer with over \textbf{3 year of experience} in \textbf{HTML, CSS, Javascript}. I have knowledge of popular frameworks such as \textbf{React, and Vue.js} and experience with REST APIs.
}
%--------------------------------------------
...
\section{Experience}
\resumeHeadingListStart{}
  \import{includes/experience/}{frontend-uccd}
...
\section{Projects}
  \resumeHeadingListStart{}
    ...
    \import{includes/projects/}{UCCD-website}
    \pagebreak
    \import{includes/projects/}{bookopia}
    % \import{includes/projects/}{monopoly-game}
  \resumeHeadingListEnd{}
%--------------------------------------------
