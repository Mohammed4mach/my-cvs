...
\small{
  Software engineer with \textbf{4+ years} of experience building performant, accessible, and well-structured front-end systems. Worked across a range of stacks — \textbf{Svelte}, \textbf{React}, \textbf{Vue} — with a strong focus on component design, \textbf{WCAG accessibility}, and \textbf{SEO} best practices including structured data. Experienced collaborating with UI/UX and content teams to deliver polished features from design to production.
}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{:}{Typescript, Javascript, HTML, CSS, SCSS}
    \resumeSectionType{Frameworks}{:}{Svelte/SvelteKit, React.js, Vue}
    \resumeSectionType{Libraries}{:}{Shadcn, Flowbite, Zod, Tailwind CSS, Socket.IO, ParaglideJs}
    \resumeSectionType{Components}{:}{Storybook, Pure Components, Composable Architecture}
    \resumeSectionType{Practices}{:}{Functional Programming, Vertical Slices, CI/CD, Cross-browser Compatibility}
    \resumeSectionType{DevOps}{:}{Git, GitHub Actions, Linux, AWS EC2, Docker}
    \resumeSectionType{Others}{:}{SEO, Structured Data (JSON-LD), Open Graph, Accessibility (WCAG), Semantic HTML, BEM}
...
\section{Experience}
\resumeHeadingListStart{}
  \import{includes/experience/}{software-engineer-bytes-maestros-frontend}
  \import{includes/experience/}{software-engineer-gopuppy-frontend}
  \import{includes/experience/}{fullstack-storiagate-frontend}
  \import{includes/experience/}{frontend-freelance}
