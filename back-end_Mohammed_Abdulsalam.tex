...
% \small{
%   Software engineer with \textbf{4+ years} of experience building and maintaining back-end systems —
%   from REST APIs and ERP platforms to event-sourced architectures. Worked
%   across freelance and corporate environments delivering production systems
%   for real clients in healthcare, industrial, and commercial domains.
...
\section{Experience}
\resumeHeadingListStart{}
  \import{includes/experience/}{software-engineer-bytes-maestros-backend}
  \import{includes/experience/}{software-engineer-gopuppy-backend}
  \import{includes/experience/}{fullstack-storiagate-backend}
  \import{includes/experience}{backend-freelance}
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{:}{PHP, Typescript, SQL, Javascript, TeX}
    \resumeSectionType{Frameworks}{:}{Laravel, Node.js}
    \resumeSectionType{Databases}{:}{PostgreSQL, MySQL, MariaDB, SQLlite}
    \resumeSectionType{Architecture}{:}{REST APIs, Event Sourcing, Vertical Slices, Clean Architecture, HMVC, MVC}
    \resumeSectionType{Practices}{:}{Functional Programming, OOP, Design Patterns, Vertical Slices, Type-Driven Development, Storybook, CI/CD}
    \resumeSectionType{DevOps}{:}{AWS EC2, Linux, Apache, Nginx, Docker, Git, Github Actions, SSH, Cron}
    \resumeSectionType{Others}{:}{ERD Design, SRS Design, User Stories, OAuth, Accessibility (WCAG), SEO}
  \resumeHeadingListEnd{}
%--------------------------------------------
