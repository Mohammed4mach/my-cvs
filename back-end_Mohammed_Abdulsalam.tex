...
\small{
  I am a highly skilled software engineer with over \textbf{3 years of experience} in \textbf{PHP and MySQL}. I know popular frameworks such as \textbf{Laravel}. I worked on several projects using native \textbf{PHP} and \textbf{MySQL/MariaDB}, as well as projects using \textbf{Laravel}, and have experience designing REST APIs.
}
%--------------------------------------------
