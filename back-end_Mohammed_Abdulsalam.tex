...
\small{
  I am a highly skilled software engineer with over \textbf{3 year of experience} in \textbf{PHP, MySQL}. I have knowledge of popular frameworks such as \textbf{Laravel}. I worked on several projects using native \textbf{PHP} and \textbf{MySQL/MariaDB}, as well as projects using \textbf{Laravel}, and have experience designing REST APIs.
}
%--------------------------------------------
