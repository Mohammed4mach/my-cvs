...
\small{
  Software engineer with \textbf{4+ years} of experience building and maintaining back-end systems — from REST APIs and ERP platforms to event-sourced architectures. Worked across freelance and corporate environments delivering production systems for real clients in healthcare, industrial, and commercial domains. Comfortable owning systems end-to-end: from requirements analysis and ERD design to deployment and server maintenance on AWS EC2.
}
%--------------------------------------------
