...
\small{
    I am a highly skilled back-end devleoper with over \textbf{2 year of experience} in \textbf{PHP, MySQL}. I have knowledge of popular frameworks such as \textbf{Laravel}. I worked on several projects using native \textbf{PHP} and \textbf{MySQL/MariaDB}, and have experience designing REST APIs.
}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Frameworks}{:}{Laravel, PHPUnit}
    \resumeSectionType{Libraries}{:}{laravel-websockets, laravel-medialibrary, laravel-echo}
