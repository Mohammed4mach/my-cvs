...
\small{
  Software engineer with \textbf{4+ years} of experience across the full stack —
  building REST APIs, ERP systems, and modern front-end applications.
  Strong in back-end architecture (\textbf{event sourcing}, \textbf{clean architecture},
  \textbf{Laravel}) and modern front-end (\textbf{React}, \textbf{Svelte}, \textbf{TypeScript},
  \textbf{Tailwind}), with a consistent focus on \textbf{accessibility},
  \textbf{SEO}, and cross-functional team collaboration.
  Comfortable owning systems end-to-end: from requirements analysis and
  design to deployment and server maintenance on \textbf{AWS EC2}.
}
%--------------------------------------------
...
\section{Experience}
\resumeHeadingListStart{}
  \import{includes/experience/}{software-engineer-bytes-maestros-fullstack}
  \import{includes/experience/}{software-engineer-gopuppy-fullstack}
  \import{includes/experience/}{fullstack-storiagate-fullstack}
...
\section{Projects}
  \resumeHeadingListStart{}
    \import{includes/projects/}{water-treatment-company-erp}
    \import{includes/projects/}{clinic-management-system}
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{:}{PHP, Typescript, Javascript,SQL,HTML, CSS/SCSS, TeX}
    \resumeSectionType{Frameworks}{:}{Laravel, Node.js, Svelte/SvelteKit, React, Vue}
    \resumeSectionType{Libraries}{:}{Shadcn, Flowbite, Zod, Tailwind CSS, Socket.IO, ParaglideJs}
    \resumeSectionType{Architecture}{:}{Event Sourcing, Clean Architecture, Vertical Slices, REST APIs, HMVC, MVC}
    \resumeSectionType{Practices}{:}{Functional Programming, OOP, Vertical Slices, Design Patterns, Type-Driven Development, Storybook, CI/CD}
    \resumeSectionType{Databases}{:}{PostgreSQL, MySQL, MariaDB, SQLlite}
    \resumeSectionType{DevOps}{:}{AWS EC2, Linux, Apache, Nginx, Docker, Git, Github Actions, SSH, Cron}
    \resumeSectionType{Others}{:}{WCAG Accessibility, Structured Data, Open Graph, Meta Tags, BEM}
  \resumeHeadingListEnd{}
%--------------------------------------------
