...
\small{
  Software engineer with \textbf{4+ years} of experience across the full stack — building REST APIs, ERP systems, and modern front-end applications. Delivered production systems in industrial, and commercial domains as both a freelancer and in corporate roles. Strong in back-end architecture (\textbf{event sourcing}, \textbf{clean architecture}, \textbf{Laravel}) and modern front-end (\textbf{Svelte}, \textbf{TypeScript}, \textbf{Tailwind}), with a consistent focus on \textbf{accessibility}, \textbf{SEO}, and cross-functional team collaboration.
}
%--------------------------------------------
