...
\small{
  I am a highly skilled web developer with over \textbf{2 year of experience} in \textbf{HTML, CSS, Javascript}, \textbf{1 year of experience} in \textbf{PHP, MySQL}. I have knowledge of popular frameworks such as \textbf{Laravel, React, and Vue.js}. I worked on several projects using native \textbf{PHP} and \textbf{MySQL/MariaDB}, and have experience designing REST APIs.
}
%--------------------------------------------
